...
# Streamlit page
# --------------------------------------------------
st.set_page_config(page_title="Property Prediction",page_icon="🏠",layout="wide")
st.title("🏠 Property Price and Investment Prediction")
st.write(
    "Enter the property details below to estimate the future property price "
...
if st.button("Predict"):
    ...
    # --------------------------------------------------
    # Default values required by the trained models
    # --------------------------------------------------
    total_floors = 5
    ...
    # --------------------------------------------------
    # Input DataFrame for regression
    # --------------------------------------------------
